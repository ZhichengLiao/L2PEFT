...
N_GPUS=${N_GPUS:-4}
MODEL_PATH=${MODEL_PATH:-/nfs-stor/zhengqing.gao/yuhao.wu/lzc/hf_cache/hub/models--meta-llama--Llama-3.2-3B-Instruct/snapshots/0cb88a4f764b7a12671c53f0838cd831a0843b95}
...
CKPT_DIR=${CKPT_DIR:-/nfs-stor/zhengqing.gao/yuhao.wu/lzc/L2PEFT/checkpoints/grpo_llama3.2_3B_it_nemotron_cascade_math_FFT_d${DATA_SEED}_r${ROLLOUT_SEED}}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=llama3.2_3B_it_grpo_nemotron_d${DATA_SEED}_r${ROLLOUT_SEED} \
