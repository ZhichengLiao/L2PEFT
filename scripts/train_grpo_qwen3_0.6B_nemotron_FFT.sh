...
CKPT_DIR=${CKPT_DIR:-/nfs-stor/zhengqing.gao/yuhao.wu/lzc/L2PEFT_checkpoints/grpo_qwen3_0.6B_nemotron_cascade_math_FFT_d${DATA_SEED}_r${ROLLOUT_SEED}}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=qwen3_0.6b_grpo_nemotron_cascade_math_d${DATA_SEED}_r${ROLLOUT_SEED} \
