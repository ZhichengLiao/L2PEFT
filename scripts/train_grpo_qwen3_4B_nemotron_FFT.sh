...
N_GPUS=${N_GPUS:-4}
MODEL_PATH=${MODEL_PATH:-/nfs-stor/zhengqing.gao/yuhao.wu/lzc/hf_cache/hub/models--Qwen--Qwen3-4B/snapshots/1cfa9a7208912126459214e8b04321603b3df60c}
...
CKPT_DIR=${CKPT_DIR:-/nfs-stor/zhengqing.gao/yuhao.wu/lzc/L2PEFT/checkpoints/grpo_qwen3_4B_nemotron_cascade_math_FFT_d${DATA_SEED}_r${ROLLOUT_SEED}}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=qwen3_4B_grpo_nemotron_cascade_math_d${DATA_SEED}_r${ROLLOUT_SEED} \
