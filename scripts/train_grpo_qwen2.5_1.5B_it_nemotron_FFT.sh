...
CKPT_DIR=${CKPT_DIR:-/nfs-stor/zhengqing.gao/yuhao.wu/lzc/L2PEFT/checkpoints/grpo_qwen2.5_1.5B_it_nemotron_cascade_math_FFT_d${DATA_SEED}_r${ROLLOUT_SEED}}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=qwen2.5_1.5B_it_grpo_nemotron_d${DATA_SEED}_r${ROLLOUT_SEED} \
