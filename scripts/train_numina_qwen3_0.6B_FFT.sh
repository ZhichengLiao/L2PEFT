...
CKPT_DIR=${CKPT_DIR:-/root/autodl-tmp/pruning/checkpoints/grpo_qwen3_0.6B_nemotron_cascade_math_FFT}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='grpo_nemotron_cascade_math_FFT_qwen3_0.6B' \
