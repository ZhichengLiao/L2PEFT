...
N_GPUS=${N_GPUS:-4}
MODEL_PATH=${MODEL_PATH:-/nfs-stor/zhengqing.gao/yuhao.wu/lzc/hf_cache/hub/models--Qwen--Qwen3-8B/snapshots/b968826d9c46dd6066d109eabc6255188de91218}
...
CKPT_DIR=${CKPT_DIR:-/nfs-stor/zhengqing.gao/yuhao.wu/lzc/L2PEFT/checkpoints/grpo_qwen3_8B_nemotron_cascade_math_FFT_d${DATA_SEED}_r${ROLLOUT_SEED}}
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name=qwen3_8B_grpo_nemotron_cascade_math_d${DATA_SEED}_r${ROLLOUT_SEED} \
